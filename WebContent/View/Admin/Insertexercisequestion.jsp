								...
								<div id="login-box" class="login-box visible widget-box no-border">
									<div class="widget-body">
										<div class="widget-main">
											...
											<form action="Uploadexercisequestion?exerciseid=<%= request.getAttribute("exerciseid")%>&type=${type}" method="POST" enctype="multipart/form-data">
												<fieldset>
												 	<label class="block clearfix" style="color:red">
														<%=request.getAttribute("msguploadquestion") !=null?request.getAttribute("msguploadquestion"):" " %>
													</label>
													...
													<div class="clearfix">
														...
														<button type="submit" class="pull-right btn btn-sm btn-primary">
															...
															<span class="bigger-110">Thêm câu hỏi bài tập</span>
														</button>
													</div>
