								...
								<div id="login-box" class="login-box visible widget-box no-border">
									<div class="widget-body">
										<div class="widget-main">
											...
											<form action="Uploadexamquestion?examinationid=<%= request.getAttribute("examinationid")%>" method="POST" enctype="multipart/form-data">
												<fieldset>
													...
													<div class="clearfix">
														...
														<button type="submit" class="pull-right btn btn-sm btn-primary">
															...
															<span class="bigger-110">Thêm câu hỏi</span>
														</button>
													</div>
