...
<head>
		...
		<meta charset="utf-8" />
		<title>Thêm danh sách bài tập</title>
	...
	<!-- End Menu -->
			...
			<div class="main-content-inner">
				<div class="breadcrumbs ace-save-state" id="breadcrumbs">
						<ul class="breadcrumb">
							...
							<c:if test="${type == 1 }">
								<li>
									<a href="#">Quản lý bài tập đọc</a>
								</li>
							</c:if>
							<c:if test="${type == 2 }">
								<li>
									<a href="#">Quản lý bài tập nghe</a>
								</li>
							</c:if>
					...
					<div class="page-content">
						<div class="row">
							<div class="col-xs-12">
							<c:if test="${msglistexercisemanage!=null}">
								<h4 class="pink">
									<i class="ace-icon fa fa-hand-o-right icon-animated-hand-pointer blue"></i>
									<a class="green" data-toggle="modal"> ${msglistexercisemanage} </a>
								</h4>
								...
								<div class="row">
									<div class="col-xs-12">
										<table id="simple-table" class="table  table-bordered table-hover">
											...
											<tbody>
												<c:forEach items="${listexercisemanage}" var = "list">
													<tr>
													<td class="center">
														${list.exerciseid}
													</td>
													...
													<td class="center">
														<a class="red" href="DeleteExercise?exerciseid=${list.exerciseid}&type=${type}">
															<i class="ace-icon fa fa-trash-o bigger-130"></i>
														</a>
													</td>
													<td class="center">
														<a class="green" href="Uploadexercisequestion?exerciseid=${list.exerciseid}&type=${type}">
										...
										<div>
											<ul class="pagination">
												...
												<c:if test="${numberpage ==1 && numberpage != maxpageid}">
													...
													<li><a href="Listexercisemanage?pageid=${numberpage +1}">Next</a></li>
												</c:if>
												
												<c:if test="${numberpage == maxpageid  && numberpage !=1}">
													<li><a href="Listexercisemanage?pageid=${numberpage -1}">Prev</a></li>
								...
								<div class="row">
									<div class="col-xs-12">
										...
										<button type="button" class="btn btn-white btn-warning btn-bold" data-toggle="modal" data-target="#myModalAudio">
											<i class="ace-icon fa fa-floppy-o bigger-120 blue"></i>
											Thêm audio và hình ảnh bài tập
										</button>
		...
		<div id="myModal" class="modal fade" role="dialog">
		  <div class="modal-dialog">
			...
			<form action="Insertexercisename?type=${type}&userid=${userid}" method="POST">
		    <!-- Modal content-->
		    <div class="modal-content">
		      <div class="modal-header">
		        <button type="button" class="close" data-dismiss="modal">&times;</button>
		        	<h4 class="modal-title">Thêm tên bài tập</h4>
		      ...
		      <div class="col-xs-12">
		        <div class="form-group">
					...
					<div class="col-sm-9">
							<input type="text" id="form-field-1-1" placeholder="Nhập tên bài tập" class="form-control" name ="name"/>
					</div>
					<label class="col-sm-3 control-label no-padding-right" for="form-field-1">Nhập số câu hỏi </label>
					<div class="col-sm-9">
							<input type="text" id="form-field-1-1" placeholder="Nhập số câu hỏi" class="form-control" name ="numquestion"/>
					</div>
				</div>
		      </div>
		      </div>
		...
		<div id="myModalAudio" class="modal fade" role="dialog">
		  <div class="modal-dialog">
			...
			<form action="UploadAudioImageExercise?type=${type}" method="POST" enctype="multipart/form-data">
		    <!-- Modal content-->
		    <div class="modal-content">
		      <div class="modal-header">
		        <button type="button" class="close" data-dismiss="modal">&times;</button>
		        	<h4 class="modal-title">Thêm Audio và hình ảnh bài tập</h4>
		      ...
		      <div class="modal-footer">
				...
				<input type="submit" value="Thêm Audio và hình ảnh" class="btn btn-info"/>
		        <button type="button" class="btn btn-default" data-dismiss="modal">Thoát</button>
