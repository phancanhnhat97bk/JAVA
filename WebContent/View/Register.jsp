			...
			function Validate(){
				...
				if(fullname =="" || name == "" || password=""){
					...
					if(password.length()<=6){
						alert("độ dài password không được <=6");
						return false;
					}
				}
			}
								...
								<div id="login-box" class="login-box visible widget-box no-border">
									<div class="widget-body">
										<div class="widget-main">
											...
											<form name="myform" action="RegisterController?roleid=2"  method="POST" onsubmit="return Validate()">
												<fieldset>
													...
													<label class="block clearfix">
														<span class="block input-icon input-icon-right">
															<input type="password" class="form-control" placeholder="Nhập mật khẩu" name ="password" onkeyup="return Validate1()"/>
