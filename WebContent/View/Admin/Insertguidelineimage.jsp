									...
									<div class="widget-body">
										<div class="widget-main">
											...
											<c:if test="${guidelineroleid==1}">
												...
												Thêm hình đại diện cho bài hướng dẫn ngữ pháp
											</c:if>
											<c:if test="${guidelineroleid==2}">
												<i class="ace-icon fa fa-coffee green"></i>
												Thêm hình đại diện cho bài hướng dẫn nghe
											</c:if>
											</h4>

											<div class="space-6"></div>

											<form action="Uploadguidelineimage?guidelineid=<%= request.getAttribute("guidelineid")%>" method="POST" enctype="multipart/form-data">
												<fieldset>
												 	<label class="block clearfix" style="color:red">
														<%=request.getAttribute("msgretrieve") !=null?request.getAttribute("msgretrieve"):" " %>
													</label>
