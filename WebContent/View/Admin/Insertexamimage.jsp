									...
									<div class="widget-body">
										<div class="widget-main">
											<h4 class="header blue lighter bigger">
												...
												Thêm hình đại diện cho đề thi
											</h4>

											<div class="space-6"></div>

											<form action="Uploadexamimage?examinationid=<%= request.getAttribute("examinationid")%>" method="POST" enctype="multipart/form-data">
												<fieldset>
												 	<label class="block clearfix" style="color:red">
														<%=request.getAttribute("msguploadimage") !=null?request.getAttribute("msguploadimage"):" " %>
													</label>
