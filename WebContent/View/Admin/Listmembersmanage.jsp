	...
	<!-- End Menu -->
		<div class="main-content">
			<div class="main-content-inner">
				<div class="breadcrumbs ace-save-state" id="breadcrumbs">
						...
						<c:if test="${roleid==3}">
							<li>
								<a href="#">Quản lý Biên tập viên</a>
							</li>
						</c:if>	
					...
					<div class="page-content">
						<div class="row">
							<div class="col-xs-12">
							<c:if test="${msglistmembersmanage!=null}">
								<h4 class="pink">
									<i class="ace-icon fa fa-hand-o-right icon-animated-hand-pointer blue"></i>
									<a class="green" data-toggle="modal"> ${msglistmembersmanage} </a>
								</h4>
							...
							<label class="block clearfix" style="color:red">
									<%=request.getAttribute("msgupdatemember") !=null?request.getAttribute("msgupdatemember"):" " %>
							</label>
								<div class="row">
									<div class="col-xs-12">
										<table id="simple-table" class="table  table-bordered table-hover">
											...
											<tbody>
												<c:forEach items="${listmembersmanage}" var = "list">
													<tr>
													<td class="center">
														${list.userid}
													</td>
													...
													<td class="center">
														<a class="red" href="Deletemember?userid=${list.userid}&roleid=${roleid}">
															<i class="ace-icon fa fa-trash-o bigger-130"></i>
														</a>
													</td>
													<td class="center">
														<a class="green popup" data-toggle="modal"data-userid="${list.userid}" data-fullname="${list.fullname}" data-name="${list.name}" data-password="${list.password}" data-target="#ModalUpdate">
										...
										<div>
											<ul class="pagination">
												...
												<c:if test="${numberpage ==1 && numberpage != maxpageid}">
													...
													<li><a href="Listmembersmanage?pageid=${numberpage +1}&roleid=${roleid}">Next</a></li>
												</c:if>
												
												<c:if test="${numberpage == maxpageid  && numberpage !=1}">
													<li><a href="Listmembersmanage?pageid=${numberpage -1}&roleid=${roleid}">Prev</a></li>
		...
		<div id="myModal" class="modal fade" role="dialog">
		  <div class="modal-dialog">
			...
			<form action="RegisterManage?roleid=${roleid}" method="POST">
		    <!-- Modal content-->
		    <div class="modal-content">
		      <div class="modal-header">
		        <button type="button" class="close" data-dismiss="modal">&times;</button>
		       		...
		       		<c:if test="${roleid ==3 }">
		       			<h4 class="modal-title">Thêm Biên Tập Viên</h4>
		       		</c:if>
		      ...
		      <div class="col-xs-12">
		        <div class="form-group">
					...
					<div class="col-sm-9">
							<input type="text" id="form-field-1-1" placeholder="Nhập tên đầy đủ" class="form-control" name ="fullname"/>
					</div>
		      ...
		      <div class="col-xs-12">
		        <div class="form-group">
					<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Nhập tên đăng nhập </label>
					<div class="col-sm-9">
							<input type="text" id="form-field-1-1" placeholder="Nhập tên đăng nhập" class="form-control" name ="name"/>
					</div>
		      ...
		      <div class="col-xs-12">
		        <div class="form-group">
					<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Nhập mật khẩu </label>
					<div class="col-sm-9">
							<input type="password" id="form-field-1-1" placeholder="Nhập mật khẩu" class="form-control" name ="password"/>
					</div>
		...
		<div id="ModalUpdate" class="modal fade" role="dialog">
		  <div class="modal-dialog">
			...
			<form action="UpdateMember?roleid=${roleid}" method="POST">
		    <!-- Modal content-->
		    <div class="modal-content">
		      <div class="modal-header">
		        <button type="button" class="close" data-dismiss="modal">&times;</button>
		        	...
		        	<c:if test="${roleid == 3 }">
		        		<h4 class="modal-title">Thay đổi thông tin biên tập thôi</h4>
		        	</c:if>
		      ...
		      <div class="col-xs-12">
		        ...
		        <input type="hidden"  class="userid" name ="userid"/>
					<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Tên đầy đủ </label>
					<div class="col-sm-9">
							<input type="text" id="form-field-1-1" placeholder="Nhập tên đầy đủ" class="form-control fullname" name ="fullname"/>
					</div>
		      ...
		      <div class="col-xs-12">
		        <div class="form-group">
					<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Nhập tên đăng nhập </label>
					<div class="col-sm-9">
							<input type="text" id="form-field-1-1" placeholder="Nhập tên đăng nhập" class="form-control name" name ="name"/>
					</div>
		      ...
		      <div class="col-xs-12">
		        <div class="form-group">
					<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Nhập mật khẩu </label>
					<div class="col-sm-9">
							<input type="password" id="form-field-1-1" placeholder="Nhập mật khẩu" class="form-control password" name ="password"/>
					</div>
